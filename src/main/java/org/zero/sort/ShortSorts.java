...
final class ShortSorts {
     ...
     * 堆排序：不稳定，原地最大堆
     */
    static void heap(short[] a, int from, int to) {
        int n = to - from;
     ...
     * 梳排序：不稳定，收缩因子 1.3
     */
    static void comb(short[] a, int from, int to) {
        int n = to - from;
        int gap = n;
     ...
     * 地精排序：稳定
     */
    static void gnome(short[] a, int from, int to) {
        int i = from;
        while (i < to) {
     ...
     * 鸡尾酒排序：稳定，双向冒泡
     */
    static void cocktail(short[] a, int from, int to) {
        int lo = from;
        int hi = to - 1;
        while (lo < hi) {
            boolean swapped = false;
     ...
     */
    static void cycle(short[] a, int from, int to) {
     ...
     * 奇偶排序：稳定，可并行化的冒泡变体
     */
    static void oddEven(short[] a, int from, int to) {
     ...
     * 煎饼排序：不稳定，前缀翻转
     */
    static void pancake(short[] a, int from, int to) {
     ...
     * 臭皮匠排序：不稳定，纯教育用途
     */
    static void stooge(short[] a, int from, int to) {
        if (to - from < 2) {
            return;
        }
     ...
     */
    static void bitonic(short[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void tree(short[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void tim(short[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void counting(short[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void pigeonhole(short[] a, int from, int to) {
        counting(a, from, to);
    }
     ...
     */
    static void radix(short[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
