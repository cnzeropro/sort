...
/**
 * char[] 专用排序实现（21 种算法中的适用子集）
 * <p>
 * 与 {@link GenericSorts}（对象数组版）算法一致：严格比较、相同稳定性。
 * 比较语义：无符号 16 位整数序（'\u0000' 最小，'\uFFFF' 最大）。
 *
 * @author Zero
 */
final class CharSorts {
     ...
     * 冒泡排序：稳定，带提前退出优化
     */
    static void bubble(char[] a, int from, int to) {
     ...
     * 选择排序：不稳定
     */
    static void selection(char[] a, int from, int to) {
     ...
     */
    static void insertion(char[] a, int from, int to) {
     ...
     */
    static void shell(char[] a, int from, int to) {
        int n = to - from;
        int h = 1;
        while (h < n / 3) {
            h = 3 * h + 1;
     ...
     */
    static void merge(char[] a, int from, int to) {
        char[] aux = new char[to - from];
        mergeRec(a, from, to, aux);
    }

    private static void mergeRec(char[] a, int from, int to, char[] aux) {
        int n = to - from;
     ...
     */
    static void quick(char[] a, int from, int to) {
        quickRec(a, from, to);
    }

    private static void quickRec(char[] a, int from, int to) {
        int n = to - from;
        if (n < INSERTION_THRESHOLD) {
            insertion(a, from, to);
            return;
     ...
     * 堆排序：不稳定，原地最大堆
     */
    static void heap(char[] a, int from, int to) {
        int n = to - from;
     ...
     * 梳排序：不稳定，收缩因子 1.3
     */
    static void comb(char[] a, int from, int to) {
        int n = to - from;
        int gap = n;
     ...
     * 地精排序：稳定
     */
    static void gnome(char[] a, int from, int to) {
        int i = from;
        while (i < to) {
     ...
     * 鸡尾酒排序：稳定，双向冒泡
     */
    static void cocktail(char[] a, int from, int to) {
        int lo = from;
        int hi = to - 1;
        while (lo < hi) {
            boolean swapped = false;
     ...
     */
    static void cycle(char[] a, int from, int to) {
     ...
     * 奇偶排序：稳定，可并行化的冒泡变体
     */
    static void oddEven(char[] a, int from, int to) {
     ...
     * 煎饼排序：不稳定，前缀翻转
     */
    static void pancake(char[] a, int from, int to) {
     ...
     * 臭皮匠排序：不稳定，纯教育用途
     */
    static void stooge(char[] a, int from, int to) {
        if (to - from < 2) {
            return;
        }
     ...
     */
    static void bitonic(char[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void tree(char[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void tim(char[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void counting(char[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
     ...
     */
    static void pigeonhole(char[] a, int from, int to) {
        counting(a, from, to);
    }
     ...
     */
    static void radix(char[] a, int from, int to) {
        int n = to - from;
        if (n < 2) {
            return;
        }
